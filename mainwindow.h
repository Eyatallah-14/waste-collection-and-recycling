...
private slots:
    ...
    void onCancelForm();
    void onApplySearch();       // Recherche dans la table principale
    void onApplySort();         // Tri dans la table principale (sur clic bouton uniquement)
...
private:
    ...
    ZonePages *zonePages;
    GestionPoubellePage *poubellePages;
    ...
    // Chart related - Graphique circulaire (pie chart)
    void drawStatsChart();
};

...
void MainWindow::on_pushButton_clicked()
{
    ...
    if (!isCollapsed) {
        // Collapse sidebar - animate width from 220 to 70
        QPropertyAnimation *logoAnim = new QPropertyAnimation(ui->logo, "geometry");
        logoAnim->setDuration(duration);
        logoAnim->setStartValue(ui->logo->geometry());
        logoAnim->setEndValue(QRect(0, 10, 70, 70));
        logoAnim->setEasingCurve(QEasingCurve::InOutQuad);
        
        // Hide text labels with fade animation
        ui->pushButton->setText(">");
        
        // Animate button collapse
        QPropertyAnimation *btn5Anim = new QPropertyAnimation(ui->pushButton_5, "geometry");
        btn5Anim->setDuration(duration);
        btn5Anim->setStartValue(ui->pushButton_5->geometry());
        QRect btn5Rect = ui->pushButton_5->geometry();
        btn5Rect.setWidth(70);
        btn5Anim->setEndValue(btn5Rect);
        btn5Anim->setEasingCurve(QEasingCurve::InOutQuad);
        
        QPropertyAnimation *btn6Anim = new QPropertyAnimation(ui->pushButton_6, "geometry");
        btn6Anim->setDuration(duration);
        btn6Anim->setStartValue(ui->pushButton_6->geometry());
        QRect btn6Rect = ui->pushButton_6->geometry();
        btn6Rect.setWidth(70);
        btn6Anim->setEndValue(btn6Rect);
        btn6Anim->setEasingCurve(QEasingCurve::InOutQuad);
        
        QPropertyAnimation *btn7Anim = new QPropertyAnimation(ui->pushButton_7, "geometry");
        btn7Anim->setDuration(duration);
        btn7Anim->setStartValue(ui->pushButton_7->geometry());
        QRect btn7Rect = ui->pushButton_7->geometry();
        btn7Rect.setWidth(70);
        btn7Anim->setEndValue(btn7Rect);
        btn7Anim->setEasingCurve(QEasingCurve::InOutQuad);
        
        QPropertyAnimation *btn8Anim = new QPropertyAnimation(ui->pushButton_8, "geometry");
        btn8Anim->setDuration(duration);
        btn8Anim->setStartValue(ui->pushButton_8->geometry());
        QRect btn8Rect = ui->pushButton_8->geometry();
        btn8Rect.setWidth(70);
        btn8Anim->setEndValue(btn8Rect);
        btn8Anim->setEasingCurve(QEasingCurve::InOutQuad);
        
        QPropertyAnimation *btn9Anim = new QPropertyAnimation(ui->pushButton_9, "geometry");
        btn9Anim->setDuration(duration);
        btn9Anim->setStartValue(ui->pushButton_9->geometry());
        QRect btn9Rect = ui->pushButton_9->geometry();
        btn9Rect.setWidth(70);
        btn9Anim->setEndValue(btn9Rect);
        btn9Anim->setEasingCurve(QEasingCurve::InOutQuad);
        
        // Start all animations
        logoAnim->start(QPropertyAnimation::DeleteWhenStopped);
        btn5Anim->start(QPropertyAnimation::DeleteWhenStopped);
        btn6Anim->start(QPropertyAnimation::DeleteWhenStopped);
        btn7Anim->start(QPropertyAnimation::DeleteWhenStopped);
        btn8Anim->start(QPropertyAnimation::DeleteWhenStopped);
        btn9Anim->start(QPropertyAnimation::DeleteWhenStopped);
        
        // Hide button text after animation starts
        ...
        // Expand sidebar - animate width from 70 to 220
        QPropertyAnimation *logoAnim = new QPropertyAnimation(ui->logo, "geometry");
        logoAnim->setDuration(duration);
        logoAnim->setStartValue(ui->logo->geometry());
        logoAnim->setEndValue(QRect(0, 10, 241, 221));
        logoAnim->setEasingCurve(QEasingCurve::InOutQuad);
        
        ui->pushButton->setText("<");
        
        // Show button text immediately
        ui->pushButton_5->setText("Zone");
        ui->pushButton_6->setText("Poubelle");
        ui->pushButton_7->setText("Employé");
        ui->pushButton_8->setText("Missions");
        ui->pushButton_9->setText("Véhicule");
